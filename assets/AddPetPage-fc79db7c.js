import{s as r,b as p,j as t,d as M,e as u,a as y,A as he,G as f,H as pe,r as x,J as xe,u as F,K as ue,Q as me,R as Y,T as J,U as G,z as K,V as ge,W as fe,X as V,Z as A,_ as N,$ as H,a0 as je}from"./index-ae1799c2.js";import{u as b}from"./formik.esm-c764e960.js";import{B as Ce}from"./BackgroundWrapper-bbc929d3.js";const d={yourPet:"yourPet",SELL:"sell",LOST_FOUND:"lost-or-found",IN_GOOD_HANDS:"in-good-hands",name:"name",birthday:"birthday",type:"type",female:"female",male:"male"},D=({currentPage:e,type:i,num:a})=>{switch(i){case"text":if(e===a)return"current";if(e>a)return"select";if(e<a)return"ordinary";break;case"bar":if(e===a)return"current";if(e>a)return"select";if(e<a)return"opacity-ordinary";break}},E={current:"#54ADFF",select:"#00C3AD",ordinary:"#888",opacityOrdinary:"#CCE4FB"},Q=e=>{switch(e.variant){case"current":return E.current;case"select":return E.select;case"ordinary":return E.ordinary;case"opacity-ordinary":return E.opacityOrdinary;default:return"tomato"}},z=({value:e,formik:i})=>i.values.gender===e?"#fff":"#888888",be=r.ul`
  max-width: 392px;
  display: flex;
...
`,Z=r.span`
  ...
  border-radius: 8px;
  background-color: ${Q};
`;function ye({currentPage:e}){return t.jsx(t.Fragment,{children:t.jsxs(be,{children:[t.jsxs(_,{children:[t.jsx(q,{variant:e===0?"current":"select",children:"Choose option"}),t.jsx(Z,{variant:e===0?"current":"select"})]}),t.jsxs(_,{children:[t.jsx(q,{variant:D({currentPage:e,type:"text",num:1}),children:"Personal details"}),t.jsx(Z,{variant:D({currentPage:e,type:"bar",num:1})})]}),t.jsxs(_,{children:[t.jsx(q,{variant:D({currentPage:e,type:"text",num:2}),children:"More info"}),t.jsx(Z,{variant:D({currentPage:e,type:"bar",num:2})})]})]})})}const Fe=r.div`
  position: absolute;
  bottom: -20px;
  left: 16px;
  font-size: 12px;
  font-weight: 400;
  color: #F43F5E;
`;function I({text:e}){return t.jsx(Fe,{children:e})}const ve="#F43F5E",we="#54ADFF",$e=({mistake:e})=>e==="true"?ve:we,Se=r.label`
  display: flex;
  flex-direction: column;
  gap: 4px;
  font-size: 14px;
...
`;function Ee({onSubmit:e,handleDefinePage:i}){const{personalDetails:a}=f(),n=b({initialValues:pe,onSubmit:e,validationSchema:Pe});return x.useEffect(()=>{for(let o in a)a[o]!==""&&n.setFieldValue(o,a[o])},[n.setFieldValue,a]),t.jsxs(ee,{onSubmit:n.handleSubmit,children:[t.jsx(g,{formik:n,placeholder:"Type name pet",text:"Pet’s name",id:"name",name:"name",onChange:n.handleChange}),t.jsx(g,{formik:n,placeholder:"Type date of birth",text:"Date of birth",id:"birthday",date:!0,name:"birthday",onChange:n.handleChange}),t.jsx(g,{formik:n,placeholder:"Type of pet",text:"Type",id:"type",name:"type",onChange:n.handleChange}),t.jsxs(L,{children:[t.jsxs(v,{type:"submit",children:["Next",t.jsx(S,{})]}),t.jsxs(w,{type:"button",onClick:()=>i(-1),children:[t.jsx($,{}),"Back"]})]})]})}const Te=M().shape({name:u().required("Please enter pet name"),birthday:u().required("Please enter date of birth"),type:u().required("Please enter breed"),title:u().required("Please enter title")});function ze({onSubmit:e,handleDefinePage:i}){const{personalDetails:a}=f(),n=b({initialValues:xe,onSubmit:e,validationSchema:Te});return x.useEffect(()=>{for(let o in a)o in a&&n.setFieldValue(o,a[o])},[]),t.jsxs(ee,{onSubmit:n.handleSubmit,children:[t.jsx(g,{formik:n,placeholder:"Title of add",text:"Title of add",id:"title",name:"title",onChange:n.handleChange}),t.jsx(g,{formik:n,placeholder:"Type name pet",text:"Pet’s name",id:"name",name:"name",onChange:n.handleChange}),t.jsx(g,{formik:n,placeholder:"Type date of birth",text:"Date of birth",id:"birthday",date:!0,name:"birthday",onChange:n.handleChange}),t.jsx(g,{formik:n,placeholder:"Type of pet",text:"Type",id:"type",name:"type",onChange:n.handleChange}),t.jsxs(L,{children:[t.jsxs(v,{disabled:n.values.option==="",type:"submit",children:["Next",t.jsx(S,{})]}),t.jsxs(w,{type:"button",onClick:()=>i(-1),children:[t.jsx($,{}),"Back"]})]})]})}function Be({option:e,handleDefinePage:i}){const a=F(),n=o=>{a(ue(o)),i(1)};return t.jsx(t.Fragment,{children:e===d.yourPet?t.jsx(Ee,{onSubmit:n,handleDefinePage:i}):t.jsx(ze,{onSubmit:n,handleDefinePage:i})})}const Oe=({mistake:e})=>e==="true"?"#F43F5E":"#54ADFF",Ve=r.label`
...
`;function k({formik:e}){const i=F(),{moreInfo:a}=f();x.useEffect(()=>{a.data.comments!==""&&e.setFieldValue("comments",a.data.comments)},[e.setFieldValue,a.data.comments]);const n=s=>{e.handleChange(s),i(me(s.target.textContent))},o=s=>{e.handleBlur(s)};return t.jsxs(Ve,{htmlFor:"comments",children:["Comments",t.jsx(Ae,{mistake:`${e.errors.comments&&e.touched.comments}`,name:"comments",id:"comments",onBlur:o,onChange:n,value:e.values.comments}),e.errors.comments&&e.touched.comments?t.jsx(I,{text:e.errors.comments}):null]})}const Ne=r.img`
  display: inline-block;
  width: 100%;
  height: 100%;
  object-fit: cover;
...
`;function R({formik:e,text:i,direction:a,items:n,justify:o,gap:s,setFile:c,file:h}){x.useEffect(()=>{h&&e.setFieldValue("photo",h)},[e.setFieldValue,h]);const l=j=>{const P=j.target.files[0];P&&(e.setFieldValue("photo",P),c(P))},m=e.errors.photo&&e.touched.photo;return t.jsxs(t.Fragment,{children:[t.jsxs(Ze,{direction:a,items:n,justify:o,gap:s,htmlFor:"photo",children:[t.jsx(ke,{children:i}),t.jsx(qe,{file:e.values.photo,mistake:`${m}`,children:e.values.photo&&t.jsx(_e,{file:e.values.photo})}),m?t.jsx(I,{text:e.errors.photo}):null]}),t.jsx(Ge,{type:"file",name:"photo",id:"photo",accept:".jpg",onBlur:e.handleFileChange,onChange:l})]})}const Re=r.label`
  display: flex;
  align-items: center;
  gap: 8px;
  padding: 8px 16px;
...
`,He=r.span`
  ...
  line-height: 1.5;
  letter-spacing: 0.64px;
`;function B({icon:e,text:i,id:a,onChange:n,value:o,checked:s,formik:c}){const h=c.errors.gender&&c.touched.gender;return t.jsxs(t.Fragment,{children:[t.jsxs(Re,{htmlFor:a,checked:s===o,children:[e,t.jsx(He,{checked:s===o,children:i}),h?t.jsx(I,{text:c.errors.gender}):null]}),t.jsx(We,{type:"radio",name:"gender",id:a,value:o,onChange:n,checked:s===o})]})}const Ue=r.form`
  height: calc(100% - 120px);
  display: flex;
  flex-direction: column;
  gap: 24px;
...
`,ct=r.input`
  ...
  opacity: 0;
  visibility: hidden;
`;function T({value:e,text:i,onChange:a,checked:n}){return t.jsxs(t.Fragment,{children:[t.jsx(lt,{htmlFor:e,children:t.jsx(rt,{checked:n,children:i})}),t.jsx(ct,{id:e,name:"option",type:"radio",onChange:a,value:e,checked:n})]})}function dt({formik:e}){return t.jsxs(t.Fragment,{children:[t.jsx(T,{onChange:e.handleChange,text:"your pet",value:d.yourPet,checked:e.values.option===d.yourPet}),t.jsx(T,{onChange:e.handleChange,text:"sell",value:d.SELL,checked:e.values.option===d.SELL}),t.jsx(T,{onChange:e.handleChange,text:"lost/found",value:d.LOST_FOUND,checked:e.values.option===d.LOST_FOUND}),t.jsx(T,{onChange:e.handleChange,text:"in good hands",value:d.IN_GOOD_HANDS,checked:e.values.option===d.IN_GOOD_HANDS})]})}const ht={option:""};function pt({handleDefinePage:e,currentPage:i}){const a=F(),n=K(),{option:o}=f(),c=b({initialValues:ht,onSubmit:h=>{i===0&&a(je(h.option)),e(1)}});return x.useEffect(()=>{o!==""&&c.setFieldValue("option",o)},[c.setFieldValue,o]),t.jsxs(Ie,{onSubmit:c.handleSubmit,children:[t.jsx(De,{children:t.jsx(dt,{formik:c})}),t.jsxs(L,{children:[t.jsxs(v,{disabled:c.values.option==="",type:"submit",children:["Next",t.jsx(S,{})]}),t.jsx(Me,{to:n.state&&n.state.from&&n.state.from.pathname||"/notices",children:t.jsxs(w,{type:"button",children:[t.jsx($,{}),"Cancel"]})})]})]})}function xt({currentPage:e,setCurrentPage:i,setFile:a,file:n}){const{option:o}=f(),s=c=>{if(c===-1&&e===0){console.log("start");return}i(h=>h+c)};return t.jsxs(t.Fragment,{children:[e===0&&t.jsx(pt,{currentPage:e,handleDefinePage:s}),e===1&&t.jsx(Be,{option:o,handleDefinePage:s}),e===2&&t.jsx(st,{setFile:a,file:n,option:o,handleDefinePage:s})]})}const ut=r.div`
  width: 100%;
...
`;function bt(){const[e,i]=x.useState(0),[a,n]=x.useState(null);return t.jsxs(t.Fragment,{children:[t.jsx(Ce,{}),t.jsx(ut,{children:t.jsxs(mt,{children:[t.jsx(gt,{children:"Add pet"}),t.jsx(ye,{currentPage:e}),t.jsx(xt,{currentPage:e,setCurrentPage:i,setFile:n,file:a})]})})]})}export{bt as default};
