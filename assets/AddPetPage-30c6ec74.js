import{s as l,b as x,j as e,d as L,e as h,D as g,E as oe,r as u,G as ie,u as f,H as le,J as re,K as k,Q as z,R as ce,T as O,U as A,V,W,X as de,a as he}from"./index-b2ea27a1.js";import{u as C}from"./formik.esm-ab0265d5.js";const c={yourPet:"yourPet",SELL:"sell",LOST_FOUND:"lost-or-found",IN_GOOD_HANDS:"in-good-hands",name:"name",birthday:"birthday",type:"type",female:"female",male:"male"},M=({currentPage:t,type:s,num:a})=>{switch(s){case"text":if(t===a)return"current";if(t>a)return"select";if(t<a)return"ordinary";break;case"bar":if(t===a)return"current";if(t>a)return"select";if(t<a)return"opacity-ordinary";break}},$={current:"#54ADFF",select:"#00C3AD",ordinary:"#888",opacityOrdinary:"#CCE4FB"},X=t=>{switch(t.variant){case"current":return $.current;case"select":return $.select;case"ordinary":return $.ordinary;case"opacity-ordinary":return $.opacityOrdinary;default:return"tomato"}},E=({value:t,formik:s})=>s.values.gender===t?"#fff":"#888888",xe=l.ul`
  min-width: 100%;
  display: flex;
