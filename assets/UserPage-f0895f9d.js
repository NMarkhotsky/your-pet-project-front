import{s as o,b as i,a as j,c as k,P as a,u as L,r as s,j as t,I as p,i as Z,Q as S,k as J,e as Q,m as W}from"./index-58b3084b.js";import{b as X,c as R,d as ee,E as u}from"./formik.esm-ebae4a40.js";const te=o.section`
...
`;const me=o.div`
  ...
  right: 3%;
  cursor: pointer;
`;k.defaults.baseURL="https://mypets-backend.onrender.com/api/";const ce=/^\+\d{2}\d{3}\d{3}\d{2}\d{2}$/,pe=3e6,E=({user:e})=>{const d=L(),[r,m]=s.useState(""),[h,g]=s.useState(void 0),[l,P]=s.useState({name:"",email:"",birthday:"",phone:"",city:""}),[c,A]=s.useState(!1),[F,C]=s.useState(!0);s.useEffect(()=>{},[r]),s.useEffect(()=>{e!==null&&(P({name:e&&e.name,email:e&&e.email,birthday:e?e.birthday:"",phone:e?e.phone:"",city:e?e.city:""}),g(e&&e.avatarURL))},[e]);const T=()=>{C(!1)},b=n=>{const{name:x,value:_}=n.target;P({...l,[x]:_})},[I,q]=s.useState(!1),U=()=>{q(!0),alert("Your photo has been successfully added")},N=()=>{C(!0),m(""),g(e&&e.avatarURL)},H=n=>{const x=n.target.files[0];x&&x.size<=pe?(m(x),g(URL.createObjectURL(x))):(S.error("Your photo is large"),m(null),g(null))},K=async()=>{try{S.success("Changes saved successfully");const n=new FormData;n.append("name",l.name),n.append("email",l.email),n.append("birthday",l.birthday),n.append("phone",l.phone),n.append("city",l.city),n.append("avatar",r);const x={};n.forEach((V,Y)=>{x[Y]=V}),console.log("formData ==>",n);const _=await k.patch("/users",n);console.log("Дані успішно відправлені:",_)}catch(n){console.error("Помилка при відправці даних:",n)}},O=()=>{A(!c)};return t.jsxs(oe,{children:[t.jsx(ae,{children:"My information:"}),t.jsx(ee,{initialValues:l,onSubmit:K,children:t.jsxs(re,{children:[t.jsx(me,{onClick:O,children:c?t.jsx(p,{iconName:"icon-cross",width:"24px",height:"24px",stroke:"#54ADFF"}):t.jsx(p,{iconName:"icon-edit",width:"24px",height:"24px",fill:"#54ADFF"})}),t.jsxs(ne,{children:[t.jsx(ie,{children:h&&t.jsx("img",{src:h,width:"182",height:"182",style:{borderRadius:40,objectFit:"cover"},alt:"Попередній перегляд аватарки"})}),c&&t.jsxs("label",{htmlFor:"avatar",style:{display:F?"flex":"none",alignItems:"center",justifyContent:"center",gap:8,cursor:"pointer"},onClick:T,children:[t.jsx(p,{iconName:"icon-camera",width:"24px",height:"24px",stroke:"#54ADFF"}),"Edit photo"]}),t.jsx(R,{style:{display:"none"},type:"file",id:"avatar",name:"avatar",accept:"image/*",onChange:H}),t.jsx(u,{name:"avatar",component:"div",style:{color:"red",fontSize:12}}),c&&!F&&t.jsxs(se,{children:[t.jsx("button",{type:"button",onClick:U,children:t.jsx(p,{iconName:"icon-check",width:"24px",height:"24px",stroke:"#54ADFF"})}),"Confirm",I&&t.jsx("button",{type:"button",onClick:N,children:t.jsx(p,{iconName:"icon-cross",width:"24px",height:"24px",stroke:"#F43F5E"})})]})]}),t.jsxs("div",{children:[t.jsxs(f,{children:[t.jsx(w,{htmlFor:"name",children:"Name:"}),t.jsx(y,{id:"name",name:"name",placeholder:"Anna",disabled:!c,value:l.name,onChange:b,required:!0}),t.jsx(u,{name:"name",component:"div",style:{color:"red",fontSize:12}})]}),t.jsxs(f,{children:[t.jsx(w,{htmlFor:"email",children:"Email:"}),t.jsx(y,{id:"email",name:"email",placeholder:"anna00@gmail.com",disabled:!c,value:l.email,onChange:b,required:!0,type:"email"}),t.jsx(u,{name:"email",component:"div",style:{color:"red",fontSize:12}})]}),t.jsxs(f,{children:[t.jsx(w,{htmlFor:"birthday",children:"Birthday:"}),t.jsx(y,{type:"date",id:"birthday",name:"birthday",disabled:!c,value:l.birthday,onChange:b,required:!0,min:new Date(1900,0,1),max:new Date}),t.jsx(u,{name:"birthday",component:"div",style:{color:"red",fontSize:12}})]}),t.jsxs(f,{children:[t.jsx(w,{htmlFor:"phone",children:"Phone:"}),t.jsx(y,{id:"phone",name:"phone",placeholder:"+38000000000",disabled:!c,value:l.phone,onChange:b,type:"number",required:!0,pattern:ce}),t.jsx(u,{name:"phone",component:"div",style:{color:"red",fontSize:12}})]}),t.jsxs(f,{children:[t.jsx(w,{htmlFor:"city",children:"City:"}),t.jsx(y,{id:"city",name:"city",placeholder:"Kyiv",disabled:!c,value:l.city,onChange:b,required:!0}),t.jsx(u,{name:"city",component:"div",style:{color:"red",fontSize:12}})]}),c?t.jsx(le,{type:"submit",children:"Save"}):t.jsxs(de,{onClick:()=>d(Z()),children:[t.jsx(p,{iconName:"icon-logout",width:"24px",height:"24px",stroke:"#54ADFF"}),t.jsx("p",{children:"Log Out"})]})]})]})})]})};E.propTypes={user:a.shape({name:a.string,email:a.string,avatarURL:a.string,birthday:a.string,phone:a.string,city:a.string,_id:a.string})};k.defaults.baseURL="https://mypets-backend.onrender.com/api/";const he=()=>{const[e,d]=s.useState(null),r=async()=>{try{const m=await k("/users"),{user:h}=await m.data;d(h)}catch(m){console.log(m.message)}};return s.useEffect(()=>{},[e]),s.useEffect(()=>{r()},[]),t.jsx(t.Fragment,{children:t.jsx(E,{user:e})})},xe=o.div``,ge=o.div`
  display: flex;
  justify-content: space-between;
...
`,Ce=document.querySelector("#modal-root"),G=({children:e,onClose:d})=>{const r=s.useCallback(({target:m,currentTarget:h,code:g})=>{(m===h||g==="Escape")&&d()},[d]);return s.useEffect(()=>(window.addEventListener("keydown",r),()=>{window.removeEventListener("keydown",r)}),[r]),J.createPortal(t.jsx($e,{onClick:r,children:t.jsxs(Pe,{children:[t.jsx(Fe,{type:"button",onClick:d,"aria-label":"close",children:t.jsx(p,{iconName:"icon-cross-small",width:"24px",height:"24px",stroke:"#54ADFF"})}),e]})}),Ce)};G.propTypes={onClose:a.func.isRequired,children:a.element.isRequired};o.div`
  display: flex;
...
`,Re=o(p)`
  ...
  fill: transparent;
`,B=({onClick:e,text:d})=>t.jsxs(Se,{onClick:e,children:[t.jsx(ze,{children:d}),t.jsx(Le,{children:t.jsx(Re,{iconName:"icon-pawprint",fill:"#FDF7F2"})})]});B.propTypes={onClick:a.func.isRequired,text:a.string.isRequired};const Ee=o.div`
  width: 280px;
  padding: 68px 16px;
  border-radius: 20px;
  background-color: ${({theme:e})=>e.colors.white};
...
`,D=({onClose:e})=>t.jsx(G,{onClose:e,children:t.jsxs(Ee,{children:[t.jsx(Me,{children:"Congrats!"}),t.jsx(Ge,{children:"Your registration is success"}),t.jsx(B,{onClick:e,text:"Go to profile"})]})});D.propTypes={onClose:a.func.isRequired};function Ae(){const{isNewUser:e}=Q(),[d,r]=s.useState(!0),m=L(),h=()=>{r(!1),m(W())};return s.useEffect(()=>{},[e]),t.jsxs(te,{children:[e&&d&&t.jsx("div",{children:t.jsx(D,{onClose:h})}),t.jsx(he,{}),t.jsx(_e,{})]})}export{Ae as default};
