import{s as r,b as v,L as E,P as A,u as M,c as R,j as o,r as d,I as f}from"./index-34c06f90.js";import{g as G,a as V,b as q,N as U}from"./NoticesCategoriesList-631b0bb6.js";import{S as W}from"./SearchInput-0888e6fe.js";import{T as _}from"./TitlePage-f0aca629.js";import"./Btn.styled-2c3f83e5.js";import"./Pagination-e1a34c0b.js";let j=(e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce((l,i)=>(i&=63,i<36?l+=i.toString(36):i<62?l+=(i-26).toString(36).toUpperCase():i>62?l+="-":l+="_",l),"");const J=[{id:j(),to:"/notices/sell",text:"sell",name:"sell"},{id:j(),to:"/notices/lost-found",text:"lost/found",name:"lost-or-found"},{id:j(),to:"/notices/for-free",text:"in good hands",name:"in-good-hands"}],K=[{id:j(),to:"/notices/favorite",text:"favorite ads",name:"favorite"},{id:j(),to:"/notices/own",text:"my ads",name:"my-ads"}],S=r.ul`
  list-style: none;
  display: flex;
  gap: 8px;
  flex-wrap: wrap;
