import{s,b as p,j as t,t as a,h as I,i as j,H as Y,a as f,L as ee,J as b,K as te,r as u,I as m,O as ne,k as v,Q as ae,R as oe,U as X,V as k,W as M,X as ie,Y as se,Z as re,_ as le,$ as de,a0 as ce,a1 as H,c as pe,a2 as xe}from"./index-a83a7f10.js";import{u as $}from"./formik.esm-23332088.js";import{B as he}from"./BackgroundWrapper-d873b979.js";const c={yourPet:"yourPet",SELL:"sell",LOST_FOUND:"lost-or-found",IN_GOOD_HANDS:"in-good-hands",name:"name",birthday:"birthday",type:"type",female:"female",male:"male"},O=({currentPage:e,type:r,num:i})=>{switch(r){case"text":if(e===i)return"current";if(e>i)return"select";if(e<i)return"ordinary";break;case"bar":if(e===i)return"current";if(e>i)return"select";if(e<i)return"opacity-ordinary";break}},D={current:"#54ADFF",select:"#00C3AD",ordinary:"#888",opacityOrdinary:"#CCE4FB"},J=e=>{switch(e.variant){case"current":return D.current;case"select":return D.select;case"ordinary":return D.ordinary;case"opacity-ordinary":return D.opacityOrdinary;default:return"tomato"}},me=s.ul`
  max-width: 392px;
  display: flex;
