import{s as r,b as k,L as H,P as A,u as G,c as M,j as o,r as d,I as b,C as V}from"./index-5a5d7908.js";import{g as q,a as U,b as W,N as _}from"./NoticesCategoriesList-a7c92cef.js";import{S as J}from"./SearchInput-341af894.js";import{T as K}from"./TitlePage-1fc863c2.js";import"./Btn.styled-be740b35.js";import"./Pagination-e68d0478.js";let v=(e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce((l,i)=>(i&=63,i<36?l+=i.toString(36):i<62?l+=(i-26).toString(36).toUpperCase():i>62?l+="-":l+="_",l),"");const Q=[{id:v(),to:"/notices/sell",text:"sell",name:"sell"},{id:v(),to:"/notices/lost-found",text:"lost/found",name:"lost-or-found"},{id:v(),to:"/notices/for-free",text:"in good hands",name:"in-good-hands"}],X=[{id:v(),to:"/notices/favorite",text:"favorite ads",name:"favorite"},{id:v(),to:"/notices/own",text:"my ads",name:"my-ads"}],N=r.ul`
  list-style: none;
  display: flex;
  gap: 8px;
  flex-wrap: wrap;
