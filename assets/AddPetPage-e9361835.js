import{s as l,b as x,j as t,d as P,e as m,G as Y,a as y,A as le,H as g,J as re,r as p,K as ce,u as F,Q as de,R as he,T as J,U as K,V as G,z as Q,W as xe,X as pe,Z as ue,_ as A,$ as V,a0 as N,a1 as H,a2 as me}from"./index-8671ccbc.js";import{u as b}from"./formik.esm-1ce19e5c.js";import{B as ge}from"./BackgroundWrapper-b1bd0f85.js";const h={yourPet:"yourPet",SELL:"sell",LOST_FOUND:"lost-or-found",IN_GOOD_HANDS:"in-good-hands",name:"name",birthday:"birthday",type:"type",female:"female",male:"male"},I=({currentPage:e,type:i,num:a})=>{switch(i){case"text":if(e===a)return"current";if(e>a)return"select";if(e<a)return"ordinary";break;case"bar":if(e===a)return"current";if(e>a)return"select";if(e<a)return"opacity-ordinary";break}},E={current:"#54ADFF",select:"#00C3AD",ordinary:"#888",opacityOrdinary:"#CCE4FB"},ee=e=>{switch(e.variant){case"current":return E.current;case"select":return E.select;case"ordinary":return E.ordinary;case"opacity-ordinary":return E.opacityOrdinary;default:return"tomato"}},O=({value:e,formik:i})=>i.values.gender===e?"#fff":"#888888",fe=l.ul`
  max-width: 392px;
  display: flex;
