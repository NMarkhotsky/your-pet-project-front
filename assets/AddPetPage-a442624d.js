import{s as o,b as p,j as t,d as D,e as g,G as k,a as m,A as ae,H as j,J as ie,r as u,I as h,K as oe,u as v,Q as se,R as le,T as J,U as K,V as R,z as Q,W as re,X as ce,Z as de,_ as A,$ as V,a0 as B,a1 as W,a2 as pe}from"./index-02054e5d.js";import{u as $}from"./formik.esm-c5727a58.js";import{B as xe}from"./BackgroundWrapper-d9845f04.js";const d={yourPet:"yourPet",SELL:"sell",LOST_FOUND:"lost-or-found",IN_GOOD_HANDS:"in-good-hands",name:"name",birthday:"birthday",type:"type",female:"female",male:"male"},T=({currentPage:e,type:s,num:i})=>{switch(s){case"text":if(e===i)return"current";if(e>i)return"select";if(e<i)return"ordinary";break;case"bar":if(e===i)return"current";if(e>i)return"select";if(e<i)return"opacity-ordinary";break}},I={current:"#54ADFF",select:"#00C3AD",ordinary:"#888",opacityOrdinary:"#CCE4FB"},Z=e=>{switch(e.variant){case"current":return I.current;case"select":return I.select;case"ordinary":return I.ordinary;case"opacity-ordinary":return I.opacityOrdinary;default:return"tomato"}},he=o.ul`
  max-width: 392px;
  display: flex;
...
`,q=o.span`
  ...
  border-radius: 8px;
  background-color: ${Z};
`;function ue({currentPage:e}){return t.jsx(t.Fragment,{children:t.jsxs(he,{children:[t.jsxs(M,{children:[t.jsx(_,{variant:e===0?"current":"select",children:"Choose option"}),t.jsx(q,{variant:e===0?"current":"select"})]}),t.jsxs(M,{children:[t.jsx(_,{variant:T({currentPage:e,type:"text",num:1}),children:"Personal details"}),t.jsx(q,{variant:T({currentPage:e,type:"bar",num:1})})]}),t.jsxs(M,{children:[t.jsx(_,{variant:T({currentPage:e,type:"text",num:2}),children:"More info"}),t.jsx(q,{variant:T({currentPage:e,type:"bar",num:2})})]})]})})}const me=o.div`
  position: absolute;
  bottom: -20px;
  left: 16px;
  font-size: 12px;
...
`;function G({formik:e}){const s=v(),{moreInfo:i}=j();u.useEffect(()=>{i.data.comments!==""&&e.setFieldValue("comments",i.data.comments)},[e.setFieldValue,i.data.comments]);const a=l=>{e.handleChange(l),s(le(l.target.textContent))},n=l=>{e.handleBlur(l)};return t.jsxs(Ie,{htmlFor:"comments",children:["Comments",t.jsx(Le,{mistake:`${e.errors.comments&&e.touched.comments}`,name:"comments",id:"comments",onBlur:n,onChange:a,value:e.values.comments}),e.errors.comments&&e.touched.comments?t.jsx(z,{text:e.errors.comments}):null]})}const Ne=o.img`
  display: inline-block;
  width: 100%;
  height: 100%;
  object-fit: cover;
  border-radius: 25px;
`;function ze({file:e}){const[s,i]=u.useState(null),a=new FileReader;return a.readAsDataURL(e),a.onload=()=>{i(a.result)},t.jsx("div",{style:{width:"100%",height:"100%"},children:t.jsx(Ne,{src:s,alt:"Preview",width:112})})}const Oe=o.div`
  width: 112px;
  height: 112px;
...
`;function Ye({formik:e,handleDefinePage:s,setFile:i,file:a}){const n=v(),{moreInfo:l}=j();u.useEffect(()=>{l.data.sex!==""&&e.setFieldValue("gender",l.data.sex)},[e.setFieldValue,l.data.sex]),u.useEffect(()=>{for(let x in l.data)l.data[x]!==""&&e.setFieldValue(x,l.data[x])},[e.setFieldValue,l.data]);const c=x=>{e.handleChange(x),n(J(x.target.id))},r=x=>{e.handleChange(x);const{name:y,value:b}=x.target;n(K({name:y,value:b}))};return t.jsxs(qe,{onSubmit:e.handleSubmit,children:[t.jsxs(Ge,{children:[t.jsxs(He,{children:[t.jsx(Xe,{children:"The Sex"}),t.jsx(We,{children:t.jsxs(Re,{children:[t.jsx(N,{formik:e,text:"Female",id:"female",onChange:c,value:d.female,checked:e.values.gender,icon:t.jsx(h,{iconName:"icon-female",stroke:e.values.gender===d.female?"#fff":e.values.gender===d.male?"#888888":"#F43F5E"})}),t.jsx(N,{formik:e,text:"Male",id:"male",onChange:c,value:d.male,checked:e.values.gender,icon:t.jsx(h,{iconName:"icon-male",stroke:e.values.gender===d.male?"#fff":e.values.gender===d.female?"#888888":"#54ADFF"})})]})}),t.jsx(H,{text:"Load the pet’s image:",setFile:i,file:a,formik:e})]}),t.jsxs(Ue,{children:[t.jsx(f,{formik:e,text:"Location",id:"location",name:"location",placeholder:"Type of location",value:e.values.location,onChange:r}),t.jsx(G,{formik:e})]})]}),t.jsxs(S,{children:[t.jsxs(C,{type:"submit",children:["Done",t.jsx(h,{iconName:"icon-pawprint",fill:"#FFFFFF"})]}),t.jsxs(w,{type:"button",onClick:()=>s(-1),children:[t.jsx(h,{iconName:"icon-arrow-left",stroke:"#54adff"}),"Back"]})]})]})}const ke=o.form`
  height: calc(100% - 120px);
  display: flex;
  flex-direction: column;
  gap: 24px;
...
`,tt=o.p`
  ...
  font-family: ${({theme:e})=>e.fonts.main.medium};
  font-size: ${({theme:e})=>e.fontSizes.lg};
`;function nt({formik:e,handleDefinePage:s,setFile:i,file:a}){const n=v(),{moreInfo:l}=j();u.useEffect(()=>{l.data.sex!==""&&e.setFieldValue("gender",l.data.sex)},[e.setFieldValue,l.data.sex]),u.useEffect(()=>{for(let x in l.data)l.data[x]!==""&&e.setFieldValue(x,l.data[x])},[e.setFieldValue,l.data]);const c=x=>{e.handleChange(x),n(J(x.target.id))},r=x=>{e.handleChange(x);const{name:y,value:b}=x.target;n(K({name:y,value:b}))};return t.jsxs(ke,{onSubmit:e.handleSubmit,children:[t.jsxs(Ke,{children:[t.jsxs(Qe,{children:[t.jsx(tt,{children:"The Sex"}),t.jsx(et,{children:t.jsxs(Je,{children:[t.jsx(N,{formik:e,text:"Female",id:"female",onChange:c,value:d.female,checked:e.values.gender,icon:t.jsx(h,{iconName:"icon-female",stroke:e.values.gender===d.female?"#fff":e.values.gender===d.male?"#888888":"#F43F5E"})}),t.jsx(N,{formik:e,text:"Male",id:"male",onChange:c,value:d.male,checked:e.values.gender,icon:t.jsx(h,{iconName:"icon-male",stroke:e.values.gender===d.male?"#fff":e.values.gender===d.female?"#888888":"#54ADFF"})})]})}),t.jsx(H,{setFile:i,file:a,text:"Load the pet’s image:",formik:e,items:"center",gap:"14px"})]}),t.jsxs(Ze,{children:[t.jsx(f,{formik:e,text:"Location",id:"location",name:"location",placeholder:"Type of location",value:e.values.location,onChange:r}),t.jsx(f,{formik:e,text:"Price",id:"price",name:"price",placeholder:"Type of price",value:e.values.price,onChange:r}),t.jsx(G,{formik:e})]})]}),t.jsxs(S,{children:[t.jsxs(C,{type:"submit",children:["Done",t.jsx(h,{iconName:"icon-pawprint",fill:"#FFFFFF"})]}),t.jsxs(w,{type:"button",onClick:()=>s(-1),children:[t.jsx(h,{iconName:"icon-arrow-left",stroke:"#54adff"}),"Back"]})]})]})}const at=o.form`
  height: calc(100% - 120px);
  display: flex;
  flex-direction: column;
  gap: 24px;
...
`,xt=o.input`
  ...
  opacity: 0;
  visibility: hidden;
`;function L({value:e,text:s,onChange:i,checked:a}){return t.jsxs(t.Fragment,{children:[t.jsx(dt,{htmlFor:e,children:t.jsx(pt,{checked:a,children:s})}),t.jsx(xt,{id:e,name:"option",type:"radio",onChange:i,value:e,checked:a})]})}function ht({formik:e}){return t.jsxs(t.Fragment,{children:[t.jsx(L,{onChange:e.handleChange,text:"your pet",value:d.yourPet,checked:e.values.option===d.yourPet}),t.jsx(L,{onChange:e.handleChange,text:"sell",value:d.SELL,checked:e.values.option===d.SELL}),t.jsx(L,{onChange:e.handleChange,text:"lost/found",value:d.LOST_FOUND,checked:e.values.option===d.LOST_FOUND}),t.jsx(L,{onChange:e.handleChange,text:"in good hands",value:d.IN_GOOD_HANDS,checked:e.values.option===d.IN_GOOD_HANDS})]})}const ut={option:""};function mt({handleDefinePage:e,currentPage:s}){const i=v(),a=Q(),{option:n}=j(),c=$({initialValues:ut,onSubmit:r=>{s===0&&i(pe(r.option)),e(1)}});return u.useEffect(()=>{n!==""&&c.setFieldValue("option",n)},[c.setFieldValue,n]),t.jsxs(ve,{onSubmit:c.handleSubmit,children:[t.jsx(Ce,{children:t.jsx(ht,{formik:c})}),t.jsxs(S,{children:[t.jsxs(C,{disabled:c.values.option==="",type:"submit",children:["Next",t.jsx(h,{iconName:"icon-pawprint",fill:"#FFFFFF"})]}),t.jsx($e,{to:a.state&&a.state.from&&a.state.from.pathname||"/notices",children:t.jsxs(w,{type:"button",children:[t.jsx(h,{iconName:"icon-arrow-left",stroke:"#54adff"}),"Cancel"]})})]})]})}function ft({currentPage:e,setCurrentPage:s,setFile:i,file:a}){const{option:n}=j(),l=c=>{if(c===-1&&e===0){console.log("start");return}s(r=>r+c)};return t.jsxs(t.Fragment,{children:[e===0&&t.jsx(mt,{currentPage:e,handleDefinePage:l}),e===1&&t.jsx(De,{option:n,handleDefinePage:l}),e===2&&t.jsx(ct,{setFile:i,file:a,option:n,handleDefinePage:l})]})}const gt=o.div`
  width: 100%;
