import{s as o,b as p,j as t,f as D,g,G as k,a as m,L as ae,H as j,J as ie,r as u,I as h,K as oe,h as v,O as se,Q as le,R as J,T as K,U as R,c as Q,V as re,W as ce,X as de,Z as A,_ as V,$ as B,a0 as W,a1 as pe}from"./index-c479c0e8.js";import{u as $}from"./formik.esm-965a53d7.js";import{B as xe}from"./BackgroundWrapper-11acfcb4.js";const d={yourPet:"yourPet",SELL:"sell",LOST_FOUND:"lost-or-found",IN_GOOD_HANDS:"in-good-hands",name:"name",birthday:"birthday",type:"type",female:"female",male:"male"},L=({currentPage:e,type:s,num:i})=>{switch(s){case"text":if(e===i)return"current";if(e>i)return"select";if(e<i)return"ordinary";break;case"bar":if(e===i)return"current";if(e>i)return"select";if(e<i)return"opacity-ordinary";break}},T={current:"#54ADFF",select:"#00C3AD",ordinary:"#888",opacityOrdinary:"#CCE4FB"},Z=e=>{switch(e.variant){case"current":return T.current;case"select":return T.select;case"ordinary":return T.ordinary;case"opacity-ordinary":return T.opacityOrdinary;default:return"tomato"}},he=o.ul`
  max-width: 392px;
  display: flex;
...
`,xt=o.input`
  ...
  opacity: 0;
  visibility: hidden;
`;function I({value:e,text:s,onChange:i,checked:a}){return t.jsxs(t.Fragment,{children:[t.jsx(dt,{htmlFor:e,children:t.jsx(pt,{checked:a,children:s})}),t.jsx(xt,{id:e,name:"option",type:"radio",onChange:i,value:e,checked:a})]})}function ht({formik:e}){return t.jsxs(t.Fragment,{children:[t.jsx(I,{onChange:e.handleChange,text:"your pet",value:d.yourPet,checked:e.values.option===d.yourPet}),t.jsx(I,{onChange:e.handleChange,text:"sell",value:d.SELL,checked:e.values.option===d.SELL}),t.jsx(I,{onChange:e.handleChange,text:"lost/found",value:d.LOST_FOUND,checked:e.values.option===d.LOST_FOUND}),t.jsx(I,{onChange:e.handleChange,text:"in good hands",value:d.IN_GOOD_HANDS,checked:e.values.option===d.IN_GOOD_HANDS})]})}const ut={option:""};function mt({handleDefinePage:e,currentPage:s}){const i=v(),a=Q(),{option:n}=j(),c=$({initialValues:ut,onSubmit:r=>{s===0&&i(pe(r.option)),e(1)}});return u.useEffect(()=>{n!==""&&c.setFieldValue("option",n)},[c.setFieldValue,n]),t.jsxs(ve,{onSubmit:c.handleSubmit,children:[t.jsx(Ce,{children:t.jsx(ht,{formik:c})}),t.jsxs(S,{children:[t.jsxs(C,{disabled:c.values.option==="",type:"submit",children:["Next",t.jsx(h,{iconName:"icon-pawprint",fill:"#FFFFFF"})]}),t.jsx($e,{to:a.state&&a.state.from&&a.state.from.pathname||"/notices",children:t.jsxs(w,{type:"button",children:[t.jsx(h,{iconName:"icon-arrow-left",stroke:"#54adff"}),"Cancel"]})})]})]})}function ft({currentPage:e,setCurrentPage:s,setFile:i,file:a}){const{option:n}=j(),l=c=>{if(c===-1&&e===0){console.log("start");return}s(r=>r+c)};return t.jsxs(t.Fragment,{children:[e===0&&t.jsx(mt,{currentPage:e,handleDefinePage:l}),e===1&&t.jsx(De,{option:n,handleDefinePage:l}),e===2&&t.jsx(ct,{setFile:i,file:a,option:n,handleDefinePage:l})]})}const gt=o.div`
  width: 100%;
