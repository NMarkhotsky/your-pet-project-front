import{s,b as f,L as H,P as A,u as G,c as M,j as t,r as d,I as y,C as W}from"./index-104862b0.js";import{g as V,a as q,b as U,N as _}from"./NoticesCategoriesList-97171778.js";import{S as J,P as K}from"./Pagination-d3315b6b.js";import{T as Q}from"./TitlePage-c63825ff.js";import"./Btn.styled-e76b24c4.js";let $=(e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce((l,r)=>(r&=63,r<36?l+=r.toString(36):r<62?l+=(r-26).toString(36).toUpperCase():r>62?l+="-":l+="_",l),"");const X=[{id:$(),to:"/notices/sell",text:"sell",name:"sell"},{id:$(),to:"/notices/lost-found",text:"lost/found",name:"lost-or-found"},{id:$(),to:"/notices/for-free",text:"in good hands",name:"in-good-hands"}],Y=[{id:$(),to:"/notices/favorite",text:"favorite ads",name:"favorite"},{id:$(),to:"/notices/own",text:"my ads",name:"my-ads"}],Z=s.div`
  display: flex;
  gap: 12px;
`,N=s.ul`
  list-style: none;
