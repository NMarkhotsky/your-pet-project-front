import{s as a,b as h,a as b,d as S,B as K,h as Z,r as u,j as s,t as d,I as v,M as U,p as je,q as be,e as $e,F as Se,v as L,w as Oe,x as Ie,n as _e,P as p,T as J,y as Me,C as Ce,z as R,Y as Ee,A as X,S as ee,D as Fe,E as ke,c as Pe,L as ze,G as Te,u as Be,H as Le}from"./index-dc9cbfa3.js";import{b as Ae,c as te,d as Re,E as Ue}from"./formik.esm-eea19d48.js";const De=a.section`
...
`;S.defaults.baseURL=K;const Ze=async()=>{try{const e=await S.get("/users"),{user:t}=await e.data;return t}catch(e){console.log(e)}},Je=async e=>{try{return await S.patch("/users",e)}catch(t){console.log(t)}},Xe=()=>{const e=Z(),[t,i]=u.useState(null),[o,n]=u.useState(!1),[r,l]=u.useState(void 0),[c,de]=u.useState(""),[x,B]=u.useState({name:"",avatar:"",birthday:"",phone:"",city:""}),[C,H]=u.useState(null),[g,E]=u.useState(!1),[N,F]=u.useState(!0);u.useEffect(()=>{n(!0),Ze().then(f=>{i(f)}).catch(f=>console.log(f)).finally(()=>n(!1))},[]),u.useEffect(()=>{},[t]);const[ue,Q]=u.useState(!1),he=()=>{Q(!0)},Y=()=>{Q(!1)};u.useEffect(()=>{t&&(B({name:t&&t.name,birthday:t?t.birthday:"",phone:t?t.phone:"",city:t?t.city:"",avatar:x.avatar||"",avatarURL:t.avatarURL}),de(t&&t.email),l(C?r:t.avatarURL))},[C,r,t,x.avatar]);const pe=()=>{F(!1)},k=f=>{const{name:y,value:O}=f.target;B({...x,[y]:O})},fe=()=>{B({...x,avatar:C}),E(!0),F(!0)},me=()=>{H(null),E(!0),F(!0)},xe=f=>{const y=f.target.files[0];y&&y.size<=Se?(H(y),l(URL.createObjectURL(y))):(L("Your photo is large"),F(!0),l(t&&t.avatarURL))},ge=async()=>{if(C&&!x.avatar){L("Press confirm or cancel your new photo");return}E(!1);try{const f=new FormData,y=Object.entries(x);let O={};y.forEach(w=>{w[1]&&(f.append(w[0],w[1]),O={...O,[w[0]]:w[1]})});const ye={};f.forEach((w,we)=>{ye[we]=w}),await Oe.validate(O),n(!0),Je(f),Ie("Changes saved successfully")}catch(f){f.name==="ValidationError"&&L(f.errors[0])}finally{n(!1)}},ve=()=>{E(!g)};return s.jsxs(qe,{children:[s.jsx(He,{children:d("user_myinfo_title")}),s.jsx(Re,{initialValues:x,onSubmit:ge,children:s.jsxs(We,{children:[s.jsx(Ke,{onClick:ve,children:g?s.jsx(v,{iconName:"icon-cross",width:"24px",height:"24px",stroke:"#54ADFF"}):s.jsx(v,{iconName:"icon-edit",width:"24px",height:"24px",fill:"#54ADFF"})}),s.jsxs(Qe,{children:[s.jsx(Ne,{children:r&&s.jsx("img",{src:r,style:{borderRadius:40,objectFit:"cover",width:"100%",height:"100%"},alt:"Попередній перегляд аватарки"})}),g&&s.jsxs("label",{htmlFor:"avatar",style:{display:N?"flex":"none",alignItems:"center",justifyContent:"center",gap:8,cursor:"pointer"},onClick:pe,children:[s.jsx(v,{iconName:"icon-camera",width:"24px",height:"24px",stroke:"#54ADFF"}),d("user_myinfo_editPhoto")]}),s.jsx(te,{style:{display:"none"},type:"file",id:"avatar",name:"avatar",accept:"image/*",onChange:xe}),s.jsx(Ue,{name:"avatar",component:"div",style:{color:"red",fontSize:12}}),g&&!N&&s.jsxs(Ye,{children:[s.jsx("button",{type:"button",onClick:fe,children:s.jsx(v,{iconName:"icon-check",width:"24px",height:"24px",stroke:"#54ADFF"})}),d("other_confirm"),s.jsx("button",{type:"button",onClick:me,children:s.jsx(v,{iconName:"icon-cross",width:"24px",height:"24px",stroke:"#F43F5E"})})]})]}),s.jsxs("div",{children:[s.jsxs(I,{children:[s.jsxs(_,{htmlFor:"name",children:[" ",d("other_name"),":"]}),s.jsx(M,{id:"name",name:"name",placeholder:"Anna",disabled:!g,value:x.name,onChange:k})]}),s.jsxs(I,{children:[s.jsxs(_,{htmlFor:"email",children:[d("other_mail"),":"]}),s.jsx(M,{id:"email",name:"email",placeholder:"anna00@gmail.com",disabled:!0,value:c})]}),s.jsxs(I,{children:[s.jsxs(_,{htmlFor:"birthday",children:[d("other_birthday"),":"]}),s.jsx(M,{type:"date",id:"birthday",name:"birthday",disabled:!g,value:x.birthday,onChange:k})]}),s.jsxs(I,{children:[s.jsxs(_,{htmlFor:"phone",children:[d("other_phone"),":"]}),s.jsx(M,{id:"phone",name:"phone",placeholder:"+38000000000",disabled:!g,value:x.phone,onChange:k})]}),s.jsxs(I,{children:[s.jsxs(_,{htmlFor:"city",children:[d("other_city"),":"]}),s.jsx(M,{id:"city",name:"city",placeholder:d("user_myinfo_formPlaceholder_city"),disabled:!g,value:x.city,onChange:k})]}),g?s.jsx(Ve,{type:"submit",children:d("user_myinfo_saveBtn")}):s.jsxs(Ge,{onClick:he,children:[s.jsx(v,{iconName:"icon-logout",width:"24px",height:"24px",stroke:"#54ADFF"}),s.jsx("p",{children:d("user_myinfo_logout")})]})]})]})}),ue&&s.jsx("div",{children:s.jsx(U,{onClose:Y,children:s.jsx(je,{handleModal:Y,handleLogout:()=>e(be())})})}),o?s.jsx($e,{}):null]})},et=()=>s.jsx(s.Fragment,{children:s.jsx(Xe,{})}),tt=a.div`
  @media ${b} {
    width: 821px;
  }
`,nt=a.div`
...
`,ce=({onClose:e})=>s.jsx(U,{onClose:e,children:s.jsxs(Yt,{children:[s.jsx(Wt,{children:"Congrats!"}),s.jsx(Vt,{children:"Your registration is success"}),s.jsx(le,{onClick:e,text:"Go to profile"})]})});ce.propTypes={onClose:p.func.isRequired};function Zt(){const{isNewUser:e}=Be(),[t,i]=u.useState(!0),o=Z(),n=()=>{i(!1),o(Le())};return u.useEffect(()=>{},[e]),s.jsxs(De,{children:[e&&t&&s.jsx("div",{children:s.jsx(ce,{onClose:n})}),s.jsx(et,{}),s.jsx(Qt,{})]})}export{Zt as default};
