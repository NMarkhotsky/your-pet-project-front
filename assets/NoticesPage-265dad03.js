import{s as r,b as v,L as E,P as A,u as M,c as R,j as o,r as d,I as f}from"./index-60ca3da1.js";import{g as G,a as V,b as q,N as U}from"./NoticesCategoriesList-fbf39a15.js";import{S as W}from"./SearchInput-9e01d054.js";import{T as _}from"./TitlePage-69ea9a5c.js";import"./Btn.styled-088aba9d.js";import"./Pagination-7f18d0d9.js";let j=(e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce((l,i)=>(i&=63,i<36?l+=i.toString(36):i<62?l+=(i-26).toString(36).toUpperCase():i>62?l+="-":l+="_",l),"");const J=[{id:j(),to:"/notices/sell",text:"sell",name:"sell"},{id:j(),to:"/notices/lost-found",text:"lost/found",name:"lost-or-found"},{id:j(),to:"/notices/for-free",text:"in good hands",name:"in-good-hands"}],K=[{id:j(),to:"/notices/favorite",text:"favorite ads",name:"favorite"},{id:j(),to:"/notices/own",text:"my ads",name:"my-ads"}],S=r.ul`
  list-style: none;
  display: flex;
  gap: 8px;
  flex-wrap: wrap;
...
`,D=({getCategoryParams:e})=>{const{isLoggedIn:l}=M(),{search:i}=R();return o.jsxs(o.Fragment,{children:[o.jsx(S,{children:J.map(({to:p,text:a,id:c,name:g})=>o.jsx("li",{children:o.jsx(N,{to:{pathname:p,search:i},onClick:()=>e(g),children:a})},c))}),l&&o.jsx(S,{children:K.map(({to:p,text:a,id:c,name:g})=>o.jsx("li",{children:o.jsx(N,{to:{pathname:p,search:i},onClick:()=>e(g),children:a})},c))})]})};D.propTypes={getCategoryParams:A.func.isRequired};const Q=r.div`
  position: absolute;
  right: 0;
  top: 0;
  z-index: 1;
