import{s as O,b as $,I as se,P as z,j as v,t as fe,r as me,a6 as he,a4 as be,a as xe}from"./index-0c2c32de.js";import{i as ve}from"./catImg-34c1bda9.js";const ye=O.form`
  position: relative;
  display: flex;
  align-items: center;
...
`,Ee=({handlePageChange:a,pageCount:G=1})=>v.jsx(Re,{children:v.jsx(je,{nextLabel:v.jsx(se,{iconName:"icon-pagination-arrow-right",width:"16",height:"7"}),onPageChange:a,pageRangeDisplayed:3,marginPagesDisplayed:1,pageCount:G,previousLabel:v.jsx(se,{iconName:"icon-pagination-arrow-left",width:"16",height:"7"}),pageClassName:"item",pageLinkClassName:"link",previousClassName:"item",previousLinkClassName:"prevLink",nextClassName:"item",nextLinkClassName:"nextLink",breakLabel:"...",breakClassName:"item",breakLinkClassName:"link",activeClassName:"active",renderOnZeroPageCount:null,className:"pagination"})});Ee.propTypes={handlePageChange:z.func.isRequired,pageCount:z.number.isRequired,currentPage:z.number};const Be=()=>{window.scrollTo({top:0,behavior:"smooth"})},Oe=O.div`
  display: flex;
...
`,De=()=>v.jsxs(Oe,{children:[v.jsxs(Se,{children:[v.jsx("p",{children:"Sorry..."})," There is no information on your request :("," "]}),v.jsx($e,{src:ve,alt:"Cat with tongue"})]});export{De as N,Ee as P,Ne as S,Be as s};
