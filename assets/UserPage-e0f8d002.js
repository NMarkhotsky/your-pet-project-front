import{s as r,b as u,a as j,c as S,B as G,u as K,r as d,j as i,I as g,M as R,m as ye,n as we,L as je,F as be,o as L,p as Se,q as $e,k as Oe,P as h,t as Ie,C as Ce,v as A,Y as Me,w as Z,S as J,x as Ee,y as Fe,z as ke,A as Pe,D as ze,g as Te,E as _e}from"./index-656c3cbe.js";import{b as Le,c as X,d as Be,E as Ae}from"./formik.esm-e261914e.js";const Re=r.section`
...
`;const Ve=r.div`
  ...
  right: 3%;
  cursor: pointer;
`;S.defaults.baseURL=G;const Ge=async()=>{try{const e=await S.get("/users"),{user:t}=await e.data;return t}catch(e){console.log(e)}},Ke=async e=>{try{return await S.patch("/users",e)}catch(t){console.log(t)}},Ze=()=>{const e=K(),[t,s]=d.useState(null),[o,n]=d.useState(!1),[a,l]=d.useState(void 0),[c,le]=d.useState(""),[m,_]=d.useState({name:"",avatar:"",birthday:"",phone:"",city:""}),[M,q]=d.useState(null),[x,E]=d.useState(!1),[N,F]=d.useState(!0);d.useEffect(()=>{n(!0),Ge().then(p=>{s(p)}).catch(p=>console.log(p)).finally(()=>n(!1))},[]),d.useEffect(()=>{},[t]);const[ce,Q]=d.useState(!1),de=()=>{Q(!0)},Y=()=>{Q(!1)};d.useEffect(()=>{t&&(_({name:t&&t.name,birthday:t?t.birthday:"",phone:t?t.phone:"",city:t?t.city:"",avatar:m.avatar||"",avatarURL:t.avatarURL}),le(t&&t.email),l(M?a:t.avatarURL))},[M,a,t,m.avatar]);const ue=()=>{F(!1)},k=p=>{const{name:v,value:$}=p.target;_({...m,[v]:$})},he=()=>{_({...m,avatar:M}),E(!0),F(!0)},pe=()=>{q(null),E(!0),F(!0)},fe=p=>{const v=p.target.files[0];v&&v.size<=be?(q(v),l(URL.createObjectURL(v))):(L("Your photo is large"),F(!0),l(t&&t.avatarURL))},me=async()=>{if(M&&!m.avatar){L("Press confirm or cancel your new photo");return}E(!1);try{const p=new FormData,v=Object.entries(m);let $={};v.forEach(y=>{y[1]&&(p.append(y[0],y[1]),$={...$,[y[0]]:y[1]})});const ge={};p.forEach((y,ve)=>{ge[ve]=y}),await Se.validate($),n(!0),Ke(p),$e("Changes saved successfully")}catch(p){p.name==="ValidationError"&&L(p.errors[0])}finally{n(!1)}},xe=()=>{E(!x)};return i.jsxs(Ue,{children:[i.jsx(De,{children:"My information:"}),i.jsx(Be,{initialValues:m,onSubmit:me,children:i.jsxs(Ye,{children:[i.jsx(Ve,{onClick:xe,children:x?i.jsx(g,{iconName:"icon-cross",width:"24px",height:"24px",stroke:"#54ADFF"}):i.jsx(g,{iconName:"icon-edit",width:"24px",height:"24px",fill:"#54ADFF"})}),i.jsxs(Ne,{children:[i.jsx(qe,{children:a&&i.jsx("img",{src:a,style:{borderRadius:40,objectFit:"cover",width:"100%",height:"100%"},alt:"Попередній перегляд аватарки"})}),x&&i.jsxs("label",{htmlFor:"avatar",style:{display:N?"flex":"none",alignItems:"center",justifyContent:"center",gap:8,cursor:"pointer"},onClick:ue,children:[i.jsx(g,{iconName:"icon-camera",width:"24px",height:"24px",stroke:"#54ADFF"}),"Edit photo"]}),i.jsx(X,{style:{display:"none"},type:"file",id:"avatar",name:"avatar",accept:"image/*",onChange:fe}),i.jsx(Ae,{name:"avatar",component:"div",style:{color:"red",fontSize:12}}),x&&!N&&i.jsxs(Qe,{children:[i.jsx("button",{type:"button",onClick:he,children:i.jsx(g,{iconName:"icon-check",width:"24px",height:"24px",stroke:"#54ADFF"})}),"Confirm",i.jsx("button",{type:"button",onClick:pe,children:i.jsx(g,{iconName:"icon-cross",width:"24px",height:"24px",stroke:"#F43F5E"})})]})]}),i.jsxs("div",{children:[i.jsxs(O,{children:[i.jsx(I,{htmlFor:"name",children:"Name:"}),i.jsx(C,{id:"name",name:"name",placeholder:"Anna",disabled:!x,value:m.name,onChange:k})]}),i.jsxs(O,{children:[i.jsx(I,{htmlFor:"email",children:"Email:"}),i.jsx(C,{id:"email",name:"email",placeholder:"anna00@gmail.com",disabled:!0,value:c})]}),i.jsxs(O,{children:[i.jsx(I,{htmlFor:"birthday",children:"Birthday:"}),i.jsx(C,{type:"date",id:"birthday",name:"birthday",disabled:!x,value:m.birthday,onChange:k})]}),i.jsxs(O,{children:[i.jsx(I,{htmlFor:"phone",children:"Phone:"}),i.jsx(C,{id:"phone",name:"phone",placeholder:"+38000000000",disabled:!x,value:m.phone,onChange:k})]}),i.jsxs(O,{children:[i.jsx(I,{htmlFor:"city",children:"City:"}),i.jsx(C,{id:"city",name:"city",placeholder:"Kyiv",disabled:!x,value:m.city,onChange:k})]}),x?i.jsx(He,{type:"submit",children:"Save"}):i.jsxs(We,{onClick:de,children:[i.jsx(g,{iconName:"icon-logout",width:"24px",height:"24px",stroke:"#54ADFF"}),i.jsx("p",{children:"Log Out"})]})]})]})}),ce&&i.jsx("div",{children:i.jsx(R,{onClose:Y,children:i.jsx(ye,{handleModal:Y,handleLogout:()=>e(we())})})}),o?i.jsx(je,{}):null]})},Je=()=>i.jsx(i.Fragment,{children:i.jsx(Ze,{})}),Xe=r.div`
  @media ${j} {
    width: 821px;
  }
`,et=r.div`
...
`,Rt=()=>i.jsx("div",{children:i.jsx(Bt,{showUnder:160,children:i.jsx(At,{children:i.jsx(g,{iconName:"icon-arrow-left",width:"24px",height:"24px",stroke:"#FFFFFF"})})})});S.defaults.baseURL=G;const Ut=async()=>{try{return await S.get("/pets")}catch(e){console.log(e)}},Dt=async e=>{try{return await S.delete(`/pets/${e}`)}catch(t){console.log(t)}},qt=()=>{const[e,t]=d.useState([]),s=ke();d.useEffect(()=>{Ut().then(({data:n})=>{t(n.pets)}).catch(n=>console.log(n))},[]),d.useEffect(()=>{e.length},[e]);const o=async n=>{await Dt(n),t(a=>a.filter(l=>l._id!==n))};return i.jsxs(Xe,{children:[i.jsxs(et,{children:[i.jsx(tt,{children:"My pets:"}),i.jsx(Pe,{to:"/add-pet",state:{from:s},children:i.jsxs(ot,{type:"button",children:["Add Pet",i.jsx(g,{iconName:"icon-plus-small",width:"24px",height:"24px",stroke:"#FEF9F9",fill:"#FEF9F9"})]})})]}),i.jsx(nt,{children:e.map(n=>i.jsx(te,{item:n,deletePet:o},n._id))}),e.length===0&&i.jsxs(st,{children:[i.jsxs(at,{children:[i.jsx("p",{children:"Sorry..."})," You do not have any pets :( ",i.jsx("br",{}),i.jsx("span",{style:{color:"#FFC107"},children:"But you can add them."})]}),i.jsx(it,{src:ft,alt:"Cat with tongue"})]}),i.jsx(Rt,{})]})},Nt=()=>i.jsx(i.Fragment,{children:i.jsx(qt,{})}),ae=({onClick:e,text:t})=>i.jsxs(ze,{onClick:e,children:[i.jsx(A,{children:t}),i.jsx(Z,{children:i.jsx(J,{iconName:"icon-pawprint",fill:"#FDF7F2"})})]});ae.propTypes={onClick:h.func.isRequired,text:h.string.isRequired};const Qt=r.div`
  width: 280px;
  padding: 68px 16px;
  border-radius: 20px;
  background-color: ${({theme:e})=>e.colors.bgdColor};
...
`,re=({onClose:e})=>i.jsx(R,{onClose:e,children:i.jsxs(Qt,{children:[i.jsx(Yt,{children:"Congrats!"}),i.jsx(Ht,{children:"Your registration is success"}),i.jsx(ae,{onClick:e,text:"Go to profile"})]})});re.propTypes={onClose:h.func.isRequired};function Gt(){const{isNewUser:e}=Te(),[t,s]=d.useState(!0),o=K(),n=()=>{s(!1),o(_e())};return d.useEffect(()=>{},[e]),i.jsxs(Re,{children:[e&&t&&i.jsx("div",{children:i.jsx(re,{onClose:n})}),i.jsx(Je,{}),i.jsx(Nt,{})]})}export{Gt as default};
