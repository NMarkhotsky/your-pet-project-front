import{s as o,b as p,j as t,f as D,g,K as k,a as m,L as ae,O as j,Q as ie,r as u,I as h,R as oe,h as v,U as se,V as le,W as K,X as Q,Z as R,c as Z,_ as re,$ as ce,a0 as de,a1 as A,a2 as V,a3 as B,a4 as H,a5 as pe}from"./index-cb6ef55e.js";import{u as $}from"./formik.esm-b5f7c3cd.js";import{B as xe}from"./BackgroundWrapper-081dd1df.js";const d={yourPet:"yourPet",SELL:"sell",LOST_FOUND:"lost-or-found",IN_GOOD_HANDS:"in-good-hands",name:"name",birthday:"birthday",type:"type",female:"female",male:"male"},L=({currentPage:e,type:s,num:i})=>{switch(s){case"text":if(e===i)return"current";if(e>i)return"select";if(e<i)return"ordinary";break;case"bar":if(e===i)return"current";if(e>i)return"select";if(e<i)return"opacity-ordinary";break}},I={current:"#54ADFF",select:"#00C3AD",ordinary:"#888",opacityOrdinary:"#CCE4FB"},J=e=>{switch(e.variant){case"current":return I.current;case"select":return I.select;case"ordinary":return I.ordinary;case"opacity-ordinary":return I.opacityOrdinary;default:return"tomato"}},he=o.ul`
  max-width: 392px;
  display: flex;
