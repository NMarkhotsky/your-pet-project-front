import{s,b as g,a as A,L as I,P as M,u as R,c as q,j as t,r as d,I as f,t as U,C as J,d as K}from"./index-344a8f1d.js";import{A as Q,g as X,a as Y,b as Z,N as ee,d as te}from"./NoticesCategoriesList-5b0038bb.js";import{s as oe,S as ne,P as se}from"./scrollToTop-28f1eff0.js";import{T as ae}from"./TitlePage-d3672e2d.js";import"./Btn.styled-3356002d.js";import"./ModalConfirmDelete-fbed82d7.js";let $=(e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce((l,c)=>(c&=63,c<36?l+=c.toString(36):c<62?l+=(c-26).toString(36).toUpperCase():c>62?l+="-":l+="_",l),"");const ie=[{id:$(),to:"/notices/sell",text:"sell",name:"sell"},{id:$(),to:"/notices/lost-found",text:"lost/found",name:"lost-or-found"},{id:$(),to:"/notices/for-free",text:"in good hands",name:"in-good-hands"}],re=[{id:$(),to:"/notices/favorite",text:"favorite ads",name:"favorite"},{id:$(),to:"/notices/own",text:"my ads",name:"my-ads"}],le=s.div`
  display: flex;
