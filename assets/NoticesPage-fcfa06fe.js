import{s,b as f,L as D,P as O,u as W,c as _,j as t,r as d,I as m,t as V,C as q,d as U}from"./index-e366dee9.js";import{g as J,a as K,b as Q,N as X}from"./NoticesCategoriesList-e749db9b.js";import{S as Y,P as Z}from"./Pagination-66a0b4ee.js";import{T as ee}from"./TitlePage-f4b5a4d6.js";import"./Btn.styled-4aa79ffe.js";import"./ModalConfirmDelete-5515c0af.js";let $=(e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce((l,r)=>(r&=63,r<36?l+=r.toString(36):r<62?l+=(r-26).toString(36).toUpperCase():r>62?l+="-":l+="_",l),"");const te=[{id:$(),to:"/notices/sell",text:"sell",name:"sell"},{id:$(),to:"/notices/lost-found",text:"lost/found",name:"lost-or-found"},{id:$(),to:"/notices/for-free",text:"in good hands",name:"in-good-hands"}],oe=[{id:$(),to:"/notices/favorite",text:"favorite ads",name:"favorite"},{id:$(),to:"/notices/own",text:"my ads",name:"my-ads"}],ne=s.div`
  display: flex;
  gap: 12px;
`,z=s.ul`
  list-style: none;
