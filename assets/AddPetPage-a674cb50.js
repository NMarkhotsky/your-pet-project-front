import{s as o,b as p,j as t,f as D,g,J as k,a as m,L as ae,K as j,O as ie,r as u,I as h,Q as oe,h as v,R as se,U as le,V as J,W as K,X as R,c as Q,Z as re,_ as ce,$ as de,a0 as A,a1 as V,a2 as B,a3 as H,a4 as pe}from"./index-dc9cbfa3.js";import{u as $}from"./formik.esm-eea19d48.js";import{B as xe}from"./BackgroundWrapper-351015ae.js";const d={yourPet:"yourPet",SELL:"sell",LOST_FOUND:"lost-or-found",IN_GOOD_HANDS:"in-good-hands",name:"name",birthday:"birthday",type:"type",female:"female",male:"male"},L=({currentPage:e,type:s,num:i})=>{switch(s){case"text":if(e===i)return"current";if(e>i)return"select";if(e<i)return"ordinary";break;case"bar":if(e===i)return"current";if(e>i)return"select";if(e<i)return"opacity-ordinary";break}},I={current:"#54ADFF",select:"#00C3AD",ordinary:"#888",opacityOrdinary:"#CCE4FB"},Z=e=>{switch(e.variant){case"current":return I.current;case"select":return I.select;case"ordinary":return I.ordinary;case"opacity-ordinary":return I.opacityOrdinary;default:return"tomato"}},he=o.ul`
  max-width: 392px;
  display: flex;
