import{s as n,b as f,L as O,P as H,u as I,c as _,j as t,r as c,I as m,t as V,C as q,d as U}from"./index-5d47b4ee.js";import{A as J,g as K,a as Q,b as X,N as Y}from"./NoticesCategoriesList-43f08da1.js";import{S as Z,P as ee}from"./Pagination-dd03892c.js";import{T as te}from"./TitlePage-cff7df38.js";import"./Btn.styled-d389e775.js";import"./ModalConfirmDelete-94681f8d.js";let v=(e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce((l,r)=>(r&=63,r<36?l+=r.toString(36):r<62?l+=(r-26).toString(36).toUpperCase():r>62?l+="-":l+="_",l),"");const oe=[{id:v(),to:"/notices/sell",text:"sell",name:"sell"},{id:v(),to:"/notices/lost-found",text:"lost/found",name:"lost-or-found"},{id:v(),to:"/notices/for-free",text:"in good hands",name:"in-good-hands"}],ne=[{id:v(),to:"/notices/favorite",text:"favorite ads",name:"favorite"},{id:v(),to:"/notices/own",text:"my ads",name:"my-ads"}],se=n.div`
  display: flex;
  gap: 12px;
`,L=n.ul`
  list-style: none;
