import{s,b as x,j as t,t as a,f as I,g as j,H as J,a as f,L as oe,J as b,K as ie,r as u,I as m,O as se,h as v,Q as re,R as le,U as K,V as Q,W as G,c as Z,X as de,Y as ce,Z as pe,_ as A,$ as V,a0 as B,a1 as Y,a2 as xe}from"./index-91850c61.js";import{u as $}from"./formik.esm-f9b2d41a.js";import{B as he}from"./BackgroundWrapper-d884b3bc.js";const p={yourPet:"yourPet",SELL:"sell",LOST_FOUND:"lost-or-found",IN_GOOD_HANDS:"in-good-hands",name:"name",birthday:"birthday",type:"type",female:"female",male:"male"},O=({currentPage:e,type:r,num:i})=>{switch(r){case"text":if(e===i)return"current";if(e>i)return"select";if(e<i)return"ordinary";break;case"bar":if(e===i)return"current";if(e>i)return"select";if(e<i)return"opacity-ordinary";break}},D={current:"#54ADFF",select:"#00C3AD",ordinary:"#888",opacityOrdinary:"#CCE4FB"},ee=e=>{switch(e.variant){case"current":return D.current;case"select":return D.select;case"ordinary":return D.ordinary;case"opacity-ordinary":return D.opacityOrdinary;default:return"tomato"}},me=s.ul`
  max-width: 392px;
  display: flex;
