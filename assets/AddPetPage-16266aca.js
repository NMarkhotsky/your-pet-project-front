import{s,b as h,j as t,d as P,e as p,a as b,A as de,G as g,H as he,r as u,J as xe,u as y,K as pe,Q as ue,R as Y,T as k,z as J,U as me,V as ge,W as A,X as V,Z as N,_ as H,$ as fe}from"./index-a57079c3.js";import{u as C}from"./formik.esm-a91c3c8b.js";import{B as je}from"./BackgroundWrapper-0ee1dda0.js";const d={yourPet:"yourPet",SELL:"sell",LOST_FOUND:"lost-or-found",IN_GOOD_HANDS:"in-good-hands",name:"name",birthday:"birthday",type:"type",female:"female",male:"male"},D=({currentPage:e,type:i,num:a})=>{switch(i){case"text":if(e===a)return"current";if(e>a)return"select";if(e<a)return"ordinary";break;case"bar":if(e===a)return"current";if(e>a)return"select";if(e<a)return"opacity-ordinary";break}},I={current:"#54ADFF",select:"#00C3AD",ordinary:"#888",opacityOrdinary:"#CCE4FB"},K=e=>{switch(e.variant){case"current":return I.current;case"select":return I.select;case"ordinary":return I.ordinary;case"opacity-ordinary":return I.opacityOrdinary;default:return"tomato"}},z=({value:e,formik:i})=>i.values.gender===e?"#fff":"#888888",Ce=s.ul`
  max-width: 392px;
  display: flex;
