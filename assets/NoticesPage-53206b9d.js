import{s,b as g,a as L,L as G,P as W,u as T,c as J,j as t,r as c,t as u,I as y,C as K,d as Q,e as X,f as Y}from"./index-230f05d6.js";import{A as Z,g as ee,a as te,b as oe,N as ne,c as se,d as ie}from"./NoticesCategoriesList-2fdb82ab.js";import{s as ae,S as re,P as le}from"./scrollToTop-483e9319.js";import{T as ce}from"./TitlePage-294afb18.js";import"./Btn.styled-5ca1b903.js";import"./ModalConfirmDelete-507c8a5e.js";import"./NoInfoPart-a939ae83.js";import"./catImg-34c1bda9.js";let k=(e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce((r,l)=>(l&=63,l<36?r+=l.toString(36):l<62?r+=(l-26).toString(36).toUpperCase():l>62?r+="-":r+="_",r),"");const de=[{id:k(),to:"/notices/sell",text:"sell",name:"sell"},{id:k(),to:"/notices/lost-found",text:"lost or found",name:"lost-or-found"},{id:k(),to:"/notices/for-free",text:"in good hands",name:"in-good-hands"}],pe=[{id:k(),to:"/notices/favorite",text:"favorite ads",name:"favorite"},{id:k(),to:"/notices/own",text:"my ads",name:"my-ads"}],ge=s.div`
  display: flex;
