import{s as o,b as p,j as t,f as D,g,G as k,a as m,L as ae,H as j,J as ie,r as u,I as h,K as oe,h as v,O as se,Q as le,R as J,T as K,U as R,c as Q,V as re,W as ce,X as de,Z as A,_ as V,$ as B,a0 as W,a1 as pe}from"./index-6697fed1.js";import{u as $}from"./formik.esm-53919ed3.js";import{B as xe}from"./BackgroundWrapper-76c7d751.js";const d={yourPet:"yourPet",SELL:"sell",LOST_FOUND:"lost-or-found",IN_GOOD_HANDS:"in-good-hands",name:"name",birthday:"birthday",type:"type",female:"female",male:"male"},L=({currentPage:e,type:s,num:i})=>{switch(s){case"text":if(e===i)return"current";if(e>i)return"select";if(e<i)return"ordinary";break;case"bar":if(e===i)return"current";if(e>i)return"select";if(e<i)return"opacity-ordinary";break}},T={current:"#54ADFF",select:"#00C3AD",ordinary:"#888",opacityOrdinary:"#CCE4FB"},Z=e=>{switch(e.variant){case"current":return T.current;case"select":return T.select;case"ordinary":return T.ordinary;case"opacity-ordinary":return T.opacityOrdinary;default:return"tomato"}},he=o.ul`
  max-width: 392px;
  display: flex;
