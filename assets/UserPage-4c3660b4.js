import{s as c,b as h,a as w,g as O,B as K,k as Z,r as d,j as r,t as u,I as v,M as R,v as xe,w as ge,d as ve,F as ye,e as A,x as we,f as je,p as be,P as x,y as Se,z as Oe,c as $e,L as Ie,T as _e,S as Me,A as Ee,D as Fe,E as ke,u as Ce,G as Pe}from"./index-ab7cf0a4.js";import{b as ze,c as J,d as Le,E as Te}from"./formik.esm-42f2ed2d.js";import{M as Be}from"./ModalConfirmDelete-8452b637.js";import{i as Ae}from"./catImg-34c1bda9.js";const Ue=c.section`
...
`,Lt=()=>r.jsx("div",{children:r.jsx(Pt,{showUnder:160,children:r.jsx(zt,{children:r.jsx(v,{iconName:"icon-arrow-left",width:"24px",height:"24px",stroke:"#FFFFFF"})})})});O.defaults.baseURL=K;const Tt=async()=>{try{return await O.get("/pets")}catch(e){console.log(e)}},Bt=async e=>{try{return await O.delete(`/pets/${e}`)}catch(t){console.log(t)}},At=()=>{const[e,t]=d.useState([]),[s,o]=d.useState(!1),n=$e();d.useEffect(()=>{Tt().then(({data:a})=>{o(!0),t(a.pets)}).catch(a=>{o(!0),console.log(a)}).finally(()=>{o(!1)})},[]),d.useEffect(()=>{e.length},[e]);const i=async a=>{await Bt(a),t(l=>l.filter(T=>T._id!==a))};return r.jsxs(Xe,{children:[r.jsxs(et,{children:[r.jsxs(tt,{children:[u("user_mypets_title"),":"]}),r.jsx(Ie,{to:"/add-pet",state:{from:n},children:r.jsxs(ot,{type:"button",children:[u("user_mypets_addBtn"),r.jsx(v,{iconName:"icon-plus-small",width:"24px",height:"24px",stroke:"#FEF9F9",fill:"#FEF9F9"})]})})]}),r.jsx(nt,{children:e.map(a=>r.jsx(X,{item:a,deletePet:i},a._id))}),e.length===0&&!s&&r.jsxs(rt,{children:[r.jsx(it,{children:r.jsxs(_e,{i18nKey:"user_mypets_petList",children:[r.jsx("p",{children:"Sorry..."})," You do not have any pets :( ",r.jsx("br",{}),r.jsx("span",{style:{color:"#FFC107"},children:"But you can add them."})]})}),r.jsx(st,{src:Ae,alt:"Cat with tongue"})]}),r.jsx(Lt,{})]})},Ut=()=>r.jsx(r.Fragment,{children:r.jsx(At,{})}),se=({onClick:e,text:t})=>r.jsxs(Me,{onClick:e,children:[r.jsx(Ee,{children:t}),r.jsx(Fe,{children:r.jsx(ke,{iconName:"icon-pawprint",fill:"#FDF7F2"})})]});se.propTypes={onClick:x.func.isRequired,text:x.string.isRequired};const Rt=c.div`
  width: 280px;
  padding: 68px 16px;
  border-radius: 20px;
...
`,re=({onClose:e})=>r.jsx(R,{onClose:e,children:r.jsxs(Rt,{children:[r.jsx(Dt,{children:"Congrats!"}),r.jsx(qt,{children:"Your registration is success"}),r.jsx(se,{onClick:e,text:"Go to profile"})]})});re.propTypes={onClose:x.func.isRequired};function Vt(){const{isNewUser:e}=Ce(),[t,s]=d.useState(!0),o=Z(),n=()=>{s(!1),o(Pe())};return d.useEffect(()=>{},[e]),r.jsxs(Ue,{children:[e&&t&&r.jsx("div",{children:r.jsx(re,{onClose:n})}),r.jsx(Je,{}),r.jsx(Ut,{})]})}export{Vt as default};
