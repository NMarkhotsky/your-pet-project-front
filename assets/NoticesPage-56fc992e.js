import{s,b as m,L as M,P as D,u as W,c as V,j as t,r as d,I as y,C as q,d as U}from"./index-acdcf974.js";import{g as _,a as J,b as K,N as Q}from"./NoticesCategoriesList-ba77ded4.js";import{S as X,P as Y}from"./Pagination-67bd5484.js";import{T as Z}from"./TitlePage-e75b0f25.js";import"./Btn.styled-53f8a1ed.js";let $=(e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce((l,r)=>(r&=63,r<36?l+=r.toString(36):r<62?l+=(r-26).toString(36).toUpperCase():r>62?l+="-":l+="_",l),"");const ee=[{id:$(),to:"/notices/sell",text:"sell",name:"sell"},{id:$(),to:"/notices/lost-found",text:"lost/found",name:"lost-or-found"},{id:$(),to:"/notices/for-free",text:"in good hands",name:"in-good-hands"}],te=[{id:$(),to:"/notices/favorite",text:"favorite ads",name:"favorite"},{id:$(),to:"/notices/own",text:"my ads",name:"my-ads"}],oe=s.div`
  display: flex;
  gap: 12px;
`,L=s.ul`
  list-style: none;
